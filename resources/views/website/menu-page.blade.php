...
<section class="menu-section">
  ...
  <div class="menu-filters">
    ...
    <!-- Menu Items -->
    <div class="menu-grid">
      <!-- Menu Card 1: Fried Eggs -->
      <div class="menu-cards">
        <img src="/assets/images/icons/Mask group (1).png" alt="Fried Eggs" class="menu-img" />
        <div class="menu-price">1000fcfa</div>
        <div class="menu-name">Fried Eggs</div>
        <div class="menu-desc">Made with eggs, lettuce, salt, oil and other ingredients.</div>
      </div>
      <!-- Menu Card 2: Hawaiian Pizza -->
      <div class="menu-cards">
        <img src="/assets/images/Mask group (1).png" alt="Hawaiian Pizza" class="menu-img" />
        <div class="menu-price">2000fcfa</div>
        <div class="menu-name">Chicken Nuggets</div>
        <div class="menu-desc">Made with eggs, lettuce, salt, oil and other ingredients.</div>
      </div>
      <!-- Menu Card 3: Martinez Cocktail -->
      <div class="menu-cards">
        <img src="/assets/images/pexels-nadin-sh-12956424 1.png" alt="Martinez Cocktail" class="menu-img" />
        <div class="menu-price">3000fcfa</div>
        <div class="menu-name">Martinez Cocktail</div>
        <div class="menu-desc">Made with eggs, lettuce, salt, oil and other ingredients.</div>
      </div>
      <!-- Menu Card 4: Butterscotch Cake -->
      <div class="menu-cards">
        <img src="/assets/images/pexels-sebastian-coman-photography-3791088 1.png" alt="Butterscotch Cake" class="menu-img" />
        <div class="menu-price">2000fcfa</div>
        <div class="menu-name">Butterscotch Cake</div>
        <div class="menu-desc">Made with eggs, lettuce, salt, oil and other ingredients.</div>
      </div>
      <!-- Menu Card 5: Mint Lemonade -->
      <div class="menu-cards">
        <img src="/assets/images/icons/Mask group.png" alt="Mint Lemonade" class="menu-img" />
        <div class="menu-price">1000fcfa</div>
        <div class="menu-name">Cheese and eggs</div>
        <div class="menu-desc">Made with eggs, lettuce, salt, oil and other ingredients.</div>
      </div>
      <!-- Menu Card 6: Chocolate Icecream -->
      <div class="menu-cards">
        <img src="/assets/images/icons/Mask group (3).png" alt="Chocolate Icecream" class="menu-img" />
        <div class="menu-price">3000fcfa</div>
        <div class="menu-name">Chocolate Icecream</div>
        <div class="menu-desc">Made with eggs, lettuce, salt, oil and other ingredients.</div>
      </div>
      <!-- Menu Card 7: Cheese Burger -->
      <div class="menu-cards">
        <img src="/assets/images/pexels-pixabay-327158 1.png" alt="Cheese Burger" class="menu-img" />
        <div class="menu-price">2000fcfa</div>
        <div class="menu-name">Cheese Burger</div>
        <div class="menu-desc">Made with eggs, lettuce, salt, oil and other ingredients.</div>
      </div>
      <!-- Menu Card 8: Classic Waffles -->
      <div class="menu-cards">
        <img src="/assets/images/icons/Mask group (5).png" alt="Classic Waffles" class="menu-img" />
        <div class="menu-price">1000fcfa</div>
        <div class="menu-name">Classic Waffles</div>
        <div class="menu-desc">Made with eggs, lettuce, salt, oil and other ingredients.</div>
      </div>
    </div>
</section>
